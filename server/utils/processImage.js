...
export const processImg = async (imageBuffer, description) => {
 ...
 `;
  ...
  Note: Make sure you provide the answer in perfect markdown format. Do not use too large headings(Always use h4). Use the correct markdown syntax to represent the content and rewrite the answer accordingly. Always leave one line extra after completing one paragraph to maintain readability. 
  `;
